    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-md-8 offset-md-2">
          ...
          <!-- New Card Section to display submitted cards -->
          <div v-if="submittedCards.length" class="row mt-5">
            <div v-for="(card, index) in submittedCards" :key="index" class="d-flex flex-wrap justify-content-start">
